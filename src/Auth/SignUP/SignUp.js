...
const RegisterSchema = Yup.object().shape({
      ...
      confirmPassword: Yup.string().required('password is required').test('passwords-match', 'Passwords must match', function(value) {
...
const SignUp = () => {
      ...
      const formsubmitHandler = (event) =>{
            ...
            fetch('https://vast-forest-59040.herokuapp.com/signup', headers).then(res => {
              console.log(res)
            }).catch(err => {
              console.log(err)
            })
...
return (
  <Formik
  initialValues={{ email: "", password: "", role: "", name:"", confirmPassword: "" }}
      ...
      <div className="parentcard">
              <div className="childcard">
                ...
                <div className="col">
                  ...
                  <Field type="email" name="email" placeholder="Enter your mail" autoComplete="off"/>
            ...
            <div className="col">
              ...
              <Link to='/Login'><button type="submit" className="loginbutton">
                Submit
              </button></Link>
            </div>
          </div>
